package priv.zhengfa.rocket.config;

/**
 * @Author: nullWagesException
 * @Date: 2020-08-15 8:47
 * @Description:
 */
public class JmsConfig {

    public static String NAME_SERVER = "111.230.150.200:9876";

    public static String TOPIC_EASY = "topic_easy";

    public static String TOPIC_ORDER = "topic_order";

    public static String TOPIC_SCHEDULE = "topic_schedule";
